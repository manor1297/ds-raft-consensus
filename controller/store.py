...
inkey = input("Enter key: ")
invalue = input("Enter value: ")
...
msg['request'] = "STORE"
msg['key'] = inkey if inkey is not "" else "K1"
msg['value'] = invalue if invalue is not "" else "Value1"
...
try:
    ...
    print("Sent STORE request to ", target)
